...
export default function AccountSettings(){
    ...
    return (
        <div className='das-container co'>
            <div className='row g-0'>

                <Typography className='col-12' align='center' sx={{ fontSize: '23px' }}>Account Settings</Typography>
                <div className='d-flex align-items-center col-12 mb-1'>
